...
# 3. Tap "+ Join Surat Adajan Hub" (X=350, Y=1380)
Write-Host "Tapping Join Surat Adajan Hub..."
& $adb -s $device shell input tap 350 1380
Start-Sleep -Seconds 2
Capture-Screen "screen_04b_chat_room_active.png"

# 4. Type message
Write-Host "Sending operational message..."
...
Write-Host "Chat verification complete!"
